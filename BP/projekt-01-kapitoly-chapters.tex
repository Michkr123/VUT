...
\label{sec:pojmy}
\begin{itemize}
  \item{\textbf{Biometrie} - automatizované rozpoznávání lidských jedinců na základě jejich charakteristických anatomických a behaviorálních rysů.} % přepsat - citace biometrie (str. 13) / Biometric identification - parafráze (str 3)
...
V dnešní moderní době, při existenci skenovacích a kopírovacích zařízení, je náchylný na falzifikaci.                             % Parafráze Biografie a identita člověka (str 440)
...
Tyto systémy jsou široce využívány v bankovnictví, právních službách, elektronických platbách a dalších oblastech, ve kterých je nutné ověřit identitu uživatele a zajistit integritu transakce. % \cite{novak2022}, \cite{kriz2019}.
...
Jsou k ní připojené všechny ostatní komponenty, které odesílají nasnímaná data.                             % V
ESP32 poté tyto data zpracovává a odesílá je do počítače, ke kterému je připojen USB kabelem.               % vlastní kec
...
Kombinuje tříosý gyroskop, tříosý akcelerometr a digitální procesor pohybu.                         % V
...
Zaznamenávaná data jsou odesílána v reálném čase mikrořadiči ESP32.                                 % vlastní kec
...
Minimální aktivační síla je 0,1 N a maximální citlivost je do 20 N.                                           % V
Řada Interlink Electronics FSR 400 je součástí rodiny jednozónových rezistorů určených pro měření síly.       % https://www.interlinkelectronics.com/fsr-400
